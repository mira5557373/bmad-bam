...
```
_bmad/bam-platform/bmad-bam-agent-atlas/resources/fragments/<name>.md
_bmad/bam-platform/bmad-bam-agent-atlas/resources/patterns/<name>.md
_bmad/bam-platform/bmad-bam-agent-atlas/resources/checklists/<gate-id>.md
_bmad/bam-platform/bmad-bam-agent-atlas/resources/standards/std-<name>.md
```
