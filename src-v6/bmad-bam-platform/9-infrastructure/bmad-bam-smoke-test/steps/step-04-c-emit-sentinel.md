...
Sanity check: read back the sentinel from the freshly generated `project-context.md` and stash it so the Plan A/B/C verification steps can compare against it. File location is BMM-aligned per v0.7 spec §7.6: `{output_folder}/bbp/project-context.md`.
...
CONTEXT_FILE="$PROJECT_ROOT/$OUTPUT_FOLDER_REL/bbp/project-context.md"
