...
- `design-tenancy-model` skill (`src-v6/bmad-bam-platform/skills/bmad-bam-design-tenancy-model/`) — primary consumer. The skill's `step-04-c-recommendation` consults this framework's Decision Tree directly; `step-05-c-write-design` enforces the Output Specification skeleton.
