...
- `{project-root}/_bmad/bam/data/templates/ai-security-assessment-template.md` - AI/LLM security assessment
- `{project-root}/_bmad/bam/data/templates/ai-security-test-plan-template.md` - AI security test planning
