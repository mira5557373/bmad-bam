...
This step loads the existing tenant SSO integration documents for modification. Edit mode allows updates to SSO requirements, IdP configuration, protocol settings, provisioning rules, or session management without recreating the entire SSO design from scratch.

---

## Prerequisites

- Existing SSO integration documents to modify
...
Load the existing tenant SSO integration documents:
...
- SSO requirements and protocol support
...
- Context: "Review SSO modification: {summary of current state and proposed changes}"
...
- Summary of current SSO configuration
