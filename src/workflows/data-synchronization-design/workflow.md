...
**Do NOT use when:**
- Data sync design already exists (use Edit mode)
- Only updating sync configurations (use Edit mode with specific focus)
- Foundation is not complete (complete `create-master-architecture` first)

**Prerequisites:**
- `master-architecture.md` with data architecture defined
