...
Generate a comprehensive validation report summarizing findings from the tenant reactivation validation steps and determining the workflow completion status.

---

## Prerequisites

- Step 20 completed: Tenant reactivation artifact loaded successfully
...
|----------|--------|-------|
| Suspension States | | States, retention, triggers |
| Reactivation Flows | | Self-service, assisted, appeal |
| Win-Back Campaigns | | Campaigns, offers, timing |
| Data Restoration | | Pipeline, integrity, cold storage |
| Operational Readiness | | Monitoring, troubleshooting, escalation |
| Events | | Reactivation events |

### 2. Assign Severity to Findings

| Severity | Description | Action Required |
|----------|-------------|-----------------|
| CRITICAL | Blocks safe reactivation | Must fix before launch |
| WARNING | Non-critical gap | Should address before scale |
| INFO | Improvement opportunity | Consider for future iterations |

**Critical Failure Examples:**
- No self-service reactivation flow
- Missing data restoration pipeline
- No integrity verification
- Undefined monitoring or escalation

### 3. Determine Completion Status

| Status | Criteria |
|--------|----------|
| **COMPLETE** | All components defined, critical checks pass, restoration tested |
...
- Context: "Review reactivation validation report and recommend next steps"
...
- Tenant Reactivation Validation Report
- Component-level findings summary
- Gate decision documentation
- **Output to:** `{output_folder}/planning-artifacts/operations/reactivation-validation-report.md`
...
- **COMPLETE:** Workflow finished. Tenant reactivation design is ready for implementation.
...
Validation mode complete for tenant-reactivation-design workflow.
