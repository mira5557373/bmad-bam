...
|------|-------------|-------------|
| **Create** | Generate new reactivation design from scratch | `steps/` |
| **Edit** | Load existing reactivation design and apply targeted modifications | `steps/` |
| **Validate** | Check existing reactivation design against quality criteria | `steps/` |
