...
Load and review existing postmortem process documents to identify sections requiring modification.

---

## Prerequisites

- Existing postmortem process documents to modify
...
Load the existing postmortem process documents:
...
|-----------|--------|-------------------|
| Template Design | Yes/No | {severity levels, impact categories} |
| Facilitation Guide | Yes/No | {scheduling, blameless principles} |
| Action Tracking | Yes/No | {priorities, owner assignment} |
| Knowledge Base | Yes/No | {pattern detection, trend analysis} |
...
- **P (Party Mode)**: Bring operations perspectives on proposed changes
...
- Context: "Review proposed modifications to postmortem process"
- Process operations and reliability perspectives on change impact
...
- Summary of current postmortem process state
