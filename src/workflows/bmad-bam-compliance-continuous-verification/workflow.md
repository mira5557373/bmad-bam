...
|------|-------------|-------------|
| **Create** | Generate new compliance verification design | `steps/step-01-c-*` |
| **Edit** | Modify existing compliance verification design | `steps/step-10-e-*` |
| **Validate** | Check compliance verification against quality criteria | `steps/step-20-v-*` |

Default: **Create** mode. In headless mode, always use Create.

### Create Mode
Follow the steps in `steps/` sequentially:
- `step-01-c-define-compliance-rules.md` - Define compliance rules and controls
- `step-02-c-design-scanning.md` - Design automated compliance scanning
- `step-03-c-design-evidence-collection.md` - Design evidence collection and drift detection
- `step-04-c-design-reporting.md` - Design regulatory reporting and dashboards
- `step-05-c-assembly.md` - Combine into continuous-verification-design.md

### Edit Mode
Load the existing output artifact, then follow:
- `step-10-e-load-existing.md` - Load existing verification design
- `step-11-e-apply-changes.md` - Apply targeted modifications

### Validate Mode
Load the existing output artifact, then follow:
- `step-20-v-load-artifact.md` - Load compliance verification design
