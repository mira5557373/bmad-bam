...
Apply requested modifications to streaming design while maintaining architecture integrity.
...
1. Identify the affected sections in the streaming design
...
4. If modifying topics:
   - Update naming conventions
   - Recalculate partition strategies
   - Update consumer group assignments
5. If modifying schemas:
   - Verify compatibility with existing versions
   - Update schema registry configuration
   - Plan migration if breaking
...
- Context: "Review applied modifications to streaming design: {summary of changes}"
...
- Updated streaming design documents
