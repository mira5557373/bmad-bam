...
Apply requested modifications to service mesh configuration documents while maintaining consistency and integrity.
...
Based on the user's requested changes, identify all affected components in the service mesh configuration documents.
...
- Document structure
- Unaffected components (mesh architecture, traffic management, tenant routing, observability)
- Cross-references between sections

### 4. Validate Configuration Consistency

If modifying service mesh configuration, verify:
- mTLS configuration consistency
- Traffic policy alignment
- Tenant routing coherence
- Observability integration integrity
...
- **P (Party Mode)**: Bring infrastructure and platform perspectives on changes
...
- Context: "Review modifications to service mesh configuration for infrastructure and consistency"
- Process infrastructure and platform perspectives
...
- Updated service mesh configuration documents
...
Edit mode complete for service-mesh-configuration workflow.
