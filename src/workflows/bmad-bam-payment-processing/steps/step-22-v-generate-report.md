...
Generate a comprehensive validation report summarizing the payment processing design quality assessment.
...
Output to: `{output_folder}/planning-artifacts/billing/payment-processing-validation-report.md`
...
- Context: "Review validation report for payment processing: {summary of findings}"
...
- [ ] PCI compliance status documented
...
- `{output_folder}/planning-artifacts/billing/payment-processing-validation-report.md`
