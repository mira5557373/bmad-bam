...
**Use when:**
- Integrating payment gateway for a multi-tenant platform
- No payment processing design exists
- Adding new payment methods or gateways
- Implementing subscription billing with automatic payments

**Do NOT use when:**
- Payment processing design already exists (use Edit mode)
- Designing invoice generation (use `invoice-generation` workflow)
- Only updating dunning rules (use Edit mode with specific focus)
...
- PCI compliance requirements documented
- Regional payment requirements identified
