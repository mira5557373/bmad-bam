...
Verify prerequisite: `master-architecture.md` must exist. If missing, inform the user to run `create-master-architecture` first.
...
Remind: After foundation stories are implemented, run `validate-foundation` to pass the foundation gate.
