...
**Next Steps:** After foundation stories are implemented, run `validate-foundation` to pass QG-F1.
...
Implement foundation epics, then run `validate-foundation` to pass QG-F1.
