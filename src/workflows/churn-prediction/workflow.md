...
|------|-------------|-------------|
| **Create** | Generate new churn prediction design | `steps/step-01-c-*` |
| **Edit** | Modify existing churn prediction design | `steps/step-10-e-*` |
| **Validate** | Check churn prediction design against quality criteria | `steps/step-20-v-*` |

Default: **Create** mode. In headless mode, always use Create.

### Create Mode
Follow the steps in `steps/` sequentially:
- `step-01-c-identify-indicators.md` - Identify leading churn indicators
- `step-02-c-design-model.md` - Design prediction model architecture
- `step-03-c-design-scoring.md` - Design risk scoring system
- `step-04-c-design-interventions.md` - Design intervention strategies

### Edit Mode
Load the existing output artifact, then follow:
- `step-10-e-load-existing.md` - Load existing churn prediction design
- `step-11-e-apply-changes.md` - Apply targeted modifications

### Validate Mode
Load the existing output artifact, then follow:
- `step-20-v-load-artifact.md` - Load churn prediction design
