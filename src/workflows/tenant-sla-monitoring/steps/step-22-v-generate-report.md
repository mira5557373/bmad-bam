...
- Quality gate contribution (QG-P1)
- Remediation recommendations (if applicable)

### 2. Save Report

Save to: `{output_folder}/planning-artifacts/validation/sla-monitoring-validation-report.md`
...
| Gate | Decision | Notes |
|------|----------|-------|
| SLA Monitoring | {PASS/CONDITIONAL/FAIL} | {summary} |
...
- Context: "Review SLA monitoring validation report"
...
- Validation report: `{output_folder}/planning-artifacts/validation/sla-monitoring-validation-report.md`
