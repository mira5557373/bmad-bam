...
Load the tenant SLA monitoring design artifact for validation against quality criteria.

---

## Prerequisites

- Existing SLA monitoring design to validate
...
Load the SLA monitoring design:
...
- Context: "Review SLA monitoring design before validation"
