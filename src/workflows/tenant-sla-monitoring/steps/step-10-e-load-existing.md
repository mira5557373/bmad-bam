...
Load and review existing tenant SLA monitoring design documents to identify sections requiring modification.

---

## Prerequisites

- Existing SLA monitoring documents to modify
...
Load the existing SLA monitoring design:
- `{output_folder}/planning-artifacts/operations/tenant-sla-monitoring.md`
...
|-----------|--------|-------------------|
| SLA Structure | YES/NO | {metrics per tier} |
| Monitoring | YES/NO | {infrastructure} |
| Breach Handling | YES/NO | {thresholds} |
...
- Context: "Review proposed modifications to SLA monitoring design"
...
- Summary of current SLA monitoring state
