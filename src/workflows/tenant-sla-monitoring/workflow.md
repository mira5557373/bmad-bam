...
|------|-------------|-------------|
| **Create** | Generate new SLA monitoring design | `steps/step-01-c-*` |
| **Edit** | Modify existing SLA monitoring design | `steps/step-10-e-*` |
| **Validate** | Check SLA monitoring design against quality criteria | `steps/step-20-v-*` |

Default: **Create** mode. In headless mode, always use Create.

### Create Mode
Follow the steps in `steps/` sequentially:
- `step-01-c-sla-definitions.md` - Define per-tenant SLA definitions
- `step-02-c-compliance-measurement.md` - Design SLA compliance measurement
- `step-03-c-breach-alerting.md` - Design breach alerting and notifications
- `step-04-c-credit-automation.md` - Design SLA credit/compensation automation
- `step-05-c-assembly.md` - Combine into sla-monitoring-design.md

### Edit Mode
Load the existing output artifact, then follow:
- `step-10-e-load-existing.md` - Load existing SLA monitoring design
- `step-11-e-apply-changes.md` - Apply targeted modifications

### Validate Mode
Load the existing output artifact, then follow:
- `step-20-v-load-artifact.md` - Load SLA monitoring design
