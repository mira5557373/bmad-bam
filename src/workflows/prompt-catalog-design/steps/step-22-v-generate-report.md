...
Generate the final validation report for the prompt catalog architecture, documenting findings, gate decision, and required remediation.
...
|----------|--------|-------|
| Catalog Requirements | PASS/FAIL | {notes} |
| Prompt Taxonomy | PASS/FAIL | {notes} |
| Tenant Isolation | PASS/FAIL | {notes} |
| Versioning Strategy | PASS/FAIL | {notes} |
| Testing Framework | PASS/FAIL | {notes} |
| A/B Testing | PASS/FAIL | {notes} |
| Performance Tracking | PASS/FAIL | {notes} |
...
- Context: "Review validation report for prompt catalog architecture"
...
- Validation report: `{output_folder}/planning-artifacts/validation/prompt-catalog-validation-report.md`
