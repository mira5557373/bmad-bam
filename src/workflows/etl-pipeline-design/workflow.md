...
**Use when:**
- Designing ETL pipelines for multi-tenant data processing
- Building data integration between tenant systems and platform
- Creating data ingestion workflows with tenant isolation
- Establishing data transformation and loading strategies

**Do NOT use when:**
- ETL pipeline design already exists (use Edit mode)
- Only validating existing pipelines (use Validate mode)
- Implementing actual ETL code (use development workflows)
...
- Understanding of data transformation requirements
