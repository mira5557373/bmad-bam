...
**Use when:**
- Implementing ASC 606 compliant revenue recognition
- No revenue recognition design exists
- Adding new revenue streams or contract types
- Integrating with accounting systems

**Do NOT use when:**
- Revenue recognition design already exists (use Edit mode)
- Designing basic billing (use `invoice-generation` workflow)
- Only updating GL mappings (use Edit mode with specific focus)
...
- ASC 606 compliance requirements documented
