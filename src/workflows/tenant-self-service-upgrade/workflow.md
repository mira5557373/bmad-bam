...
|------|-------------|-------------|
| **Create** | Generate new self-service upgrade design from scratch | `steps/` |
| **Edit** | Load existing upgrade design and apply targeted modifications | `steps/` |
| **Validate** | Check existing upgrade design against quality criteria | `steps/` |

Default: **Create** mode. In headless mode, always use Create.

### Create Mode
Follow the steps in `steps/` sequentially (step-01-c through step-03-c).
