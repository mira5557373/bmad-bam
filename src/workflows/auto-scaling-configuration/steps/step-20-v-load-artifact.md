...
Load the Auto-Scaling Configuration artifact for validation. This document defines the infrastructure scaling behavior including metrics, policies, tenant fairness controls, and cost optimization strategies.
...
Read from `{output_folder}/planning-artifacts/infrastructure/auto-scaling-configuration.md`
...
The auto-scaling-configuration.md should contain:
- Scaling Metrics with thresholds
- Policy Design per workload
- Tenant Fairness with quotas
...
- Context: "Review auto-scaling configuration structure: {summary of sections and completeness}"
