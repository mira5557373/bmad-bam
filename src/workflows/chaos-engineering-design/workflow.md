...
|------|-------------|-------------|
| **Create** | Generate new chaos engineering design | `steps/step-01-c-*` |
| **Edit** | Modify existing chaos engineering design | `steps/step-10-e-*` |
| **Validate** | Check chaos engineering design against quality criteria | `steps/step-20-v-*` |

Default: **Create** mode. In headless mode, always use Create.

### Create Mode
Follow the steps in `steps/` sequentially:
- `step-01-c-design-experiments.md` - Design chaos experiments
- `step-02-c-blast-radius.md` - Design blast radius controls
- `step-03-c-assembly.md` - Combine into chaos-engineering-design.md

### Edit Mode
Load the existing output artifact, then follow:
- `step-10-e-load-existing.md` - Load existing chaos engineering design
- `step-11-e-apply-changes.md` - Apply targeted modifications

### Validate Mode
Load the existing output artifact, then follow:
- `step-20-v-load-artifact.md` - Load chaos engineering design
