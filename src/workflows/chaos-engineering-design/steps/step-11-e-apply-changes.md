...
Apply targeted modifications to chaos engineering design.
...
| Action | Path |
|--------|------|
| Save | `{output_folder}/planning-artifacts/operations/chaos-engineering-design.md` |
...
- Updated chaos engineering design
