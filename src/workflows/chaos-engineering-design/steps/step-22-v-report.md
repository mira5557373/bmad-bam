...
Generate validation report for chaos engineering design.
...
| Gate | Contribution |
|------|--------------|
| QG-P1 (Production) | Resilience testing readiness |

### 3. Save Report

| Action | Path |
|--------|------|
| Output to | `{output_folder}/planning-artifacts/validation/chaos-engineering-validation-report.md` |
...
- Validation report at `{output_folder}/planning-artifacts/validation/chaos-engineering-validation-report.md`
