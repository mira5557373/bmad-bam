...
Apply requested modifications to SDK configuration while maintaining generation integrity.
...
1. Identify the affected sections in the SDK configuration
2. Present the current content of each affected section
3. Apply the requested modifications while preserving:
   - Document structure and formatting
   - Existing generator configurations (unless updating)
   - Cross-references between documents
4. If modifying target languages:
   - Update generator configurations
   - Regenerate structure documents
   - Update documentation templates
5. If modifying authentication:
   - Update auth helper specifications
   - Verify tenant context compatibility
...
- Context: "Review applied modifications to SDK configuration: {summary of changes}"
...
- Updated SDK configuration documents
