...
**Do NOT use when:**
- Custom domain design already exists (use Edit mode)
- Only updating SSL certificates (use Edit mode with specific focus)
- Foundation is not complete (complete `create-master-architecture` first)

**Prerequisites:**
- `master-architecture.md` with infrastructure defined
- Understanding of DNS provider requirements
- SSL/TLS certificate strategy selected
