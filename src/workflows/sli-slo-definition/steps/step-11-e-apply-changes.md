...
Apply the targeted modifications to the SLI/SLO definition document based on user requirements identified in the previous step.
...
- SLI specification changes
- SLO target adjustments
- Error budget policy updates
- Tenant-tier SLA modifications
...
- Verify SLO targets align with SLI definitions
- Check error budget calculations match SLO targets
- Ensure SLA commitments have backing SLOs with buffer
- Validate tier consistency across all metrics
...
- Context: "Review SLI/SLO modifications: {summary of changes made}"
...
- [ ] SLO-SLI alignment validated
- [ ] Error budget calculations verified
- [ ] SLA-SLO mapping confirmed
...
- Modified SLI/SLO definition document
...
Edit mode complete. The modified SLI/SLO definition is saved at:
