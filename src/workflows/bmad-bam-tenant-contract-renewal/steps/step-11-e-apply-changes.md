...
Apply requested modifications to contract renewal documents while maintaining consistency and integrity.
...
Based on the user's requested changes, identify all affected components in the contract renewal documents.
...
- Document structure
- Unaffected components (contract types, notifications, runbook)
- Cross-references between documents

### 4. Validate Renewal Flow Consistency

If modifying contract terms or notifications, verify:
- All notification timelines comply with requirements
- Pricing rules consistent with contract types
- Renegotiation workflow still valid
- Runbook procedures aligned with changes
...
- **P (Party Mode)**: Bring finance and legal perspectives on changes
...
- Context: "Review modifications to contract renewal design for consistency"
- Process finance and legal perspectives
...
- [ ] Renewal flow consistency verified
...
- Updated contract renewal documents
