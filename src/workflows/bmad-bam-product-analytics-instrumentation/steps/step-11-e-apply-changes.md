...
Apply targeted modifications to product analytics instrumentation design.
...
Save to: `{output_folder}/planning-artifacts/analytics/product-analytics-instrumentation-design.md`
...
- Updated instrumentation design document
