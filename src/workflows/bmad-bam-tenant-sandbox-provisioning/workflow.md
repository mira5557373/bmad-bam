...
|------|-------------|-------------|
| **Create** | Generate new sandbox provisioning design | `steps/step-01-c-*` |
| **Edit** | Modify existing sandbox provisioning design | `steps/step-10-e-*` |
| **Validate** | Check sandbox provisioning design against quality criteria | `steps/step-20-v-*` |

Default: **Create** mode. In headless mode, always use Create.

### Create Mode
Follow the steps in `steps/` sequentially:
- `step-01-c-sandbox-isolation.md` - Define sandbox isolation strategy
- `step-02-c-data-seeding.md` - Design data seeding strategies
- `step-03-c-lifecycle-management.md` - Design sandbox lifecycle management
- `step-04-c-self-service.md` - Design tenant self-service sandbox creation
- `step-05-c-assembly.md` - Combine into sandbox-provisioning-design.md

### Edit Mode
Load the existing output artifact, then follow:
- `step-10-e-load-existing.md` - Load existing sandbox provisioning design
- `step-11-e-apply-changes.md` - Apply targeted modifications

### Validate Mode
Load the existing output artifact, then follow:
- `step-20-v-load-artifact.md` - Load sandbox provisioning design
