...
Save to: `{output_folder}/planning-artifacts/validation/sandbox-provisioning-validation-report.md`
...
| Gate | Decision | Notes |
|------|----------|-------|
| Sandbox Provisioning | {PASS/CONDITIONAL/FAIL} | {summary} |
...
- Context: "Review sandbox provisioning validation report"
...
- Validation report: `{output_folder}/planning-artifacts/validation/sandbox-provisioning-validation-report.md`
