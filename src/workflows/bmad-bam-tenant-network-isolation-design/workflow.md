...
**Do NOT use when:**
- Network isolation design already exists (use Edit mode)
- Only updating security groups (use Edit mode with specific focus)
...
- Understanding of cloud provider VPC capabilities
