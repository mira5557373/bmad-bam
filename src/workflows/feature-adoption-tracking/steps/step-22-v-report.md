...
Generate validation report for feature adoption tracking design.
...
- QG-P1 (Production): Feature analytics readiness

### 3. Save Report

Output to: `{output_folder}/planning-artifacts/validation/feature-adoption-tracking-validation-report.md`
...
- Validation report at `{output_folder}/planning-artifacts/validation/feature-adoption-tracking-validation-report.md`
