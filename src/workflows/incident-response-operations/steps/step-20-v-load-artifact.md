...
Load the incident report documents for validation against the QG-IR1 quality gate criteria for incident response completeness.
...
Parse the document structure and prepare for validation against the QG-IR1 quality criteria.

### 3. Pre-Validation Check

| Component | Present | Status |
|-----------|---------|--------|
| Incident classification | Yes/No | {ready/incomplete} |
| Response team roster | Yes/No | {ready/incomplete} |
| Investigation findings | Yes/No | {ready/incomplete} |
| Mitigation documentation | Yes/No | {ready/incomplete} |
| Resolution verification | Yes/No | {ready/incomplete} |
| Postmortem scheduling | Yes/No | {ready/incomplete} |
...
- **C (Continue)**: Proceed to detailed validation against QG-IR1 criteria
...
- Context: "Review incident report artifact readiness for QG-IR1 validation"
