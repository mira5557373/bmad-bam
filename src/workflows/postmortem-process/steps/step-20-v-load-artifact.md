...
Load the postmortem process documents for validation against operations and reliability criteria.
...
Parse the document structure and prepare for validation against operations criteria.

### 3. Pre-Validation Check

| Component | Present | Status |
|-----------|---------|--------|
| Template Design | Yes/No | {ready/incomplete} |
| Facilitation Guide | Yes/No | {ready/incomplete} |
| Action Tracking | Yes/No | {ready/incomplete} |
| Knowledge Base | Yes/No | {ready/incomplete} |
...
- **C (Continue)**: Proceed to detailed validation against operations criteria
...
- Context: "Review postmortem process artifact readiness for validation"
...
Proceed to `step-21-v-validate.md` to run validation checks against operations criteria.
