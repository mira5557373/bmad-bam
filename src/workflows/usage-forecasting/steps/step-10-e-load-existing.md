...
Load existing usage forecasting design for modification.
...
- Usage forecasting design artifact exists at output location
...
Load: `{output_folder}/planning-artifacts/analytics/usage-forecasting-design.md`
...
- Loaded forecasting design content
