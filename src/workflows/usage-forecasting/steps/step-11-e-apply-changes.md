...
Apply targeted modifications to usage forecasting design.
...
Save to: `{output_folder}/planning-artifacts/analytics/usage-forecasting-design.md`
...
- Updated forecasting design document
