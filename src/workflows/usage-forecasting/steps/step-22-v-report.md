...
Generate validation report for usage forecasting design.
...
- QG-P1 (Production): Capacity planning readiness

### 3. Save Report

Output to: `{output_folder}/planning-artifacts/validation/usage-forecasting-validation-report.md`
...
- Validation report at `{output_folder}/planning-artifacts/validation/usage-forecasting-validation-report.md`
