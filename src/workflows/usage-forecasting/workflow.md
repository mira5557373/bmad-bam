...
|------|-------------|-------------|
| **Create** | Generate new forecasting design | `steps/step-01-c-*` |
| **Edit** | Modify existing forecasting design | `steps/step-10-e-*` |
| **Validate** | Check forecasting design against quality criteria | `steps/step-20-v-*` |

Default: **Create** mode. In headless mode, always use Create.

### Create Mode
Follow the steps in `steps/` sequentially:
- `step-01-c-analyze-patterns.md` - Analyze usage patterns and seasonality
- `step-02-c-design-models.md` - Design forecasting models
- `step-03-c-design-scaling.md` - Design scaling recommendations

### Edit Mode
Load the existing output artifact, then follow:
- `step-10-e-load-existing.md` - Load existing forecasting design
- `step-11-e-apply-changes.md` - Apply targeted modifications

### Validate Mode
Load the existing output artifact, then follow:
- `step-20-v-load-artifact.md` - Load forecasting design
