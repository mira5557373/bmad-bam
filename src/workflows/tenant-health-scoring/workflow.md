...
|------|-------------|-------------|
| **Create** | Generate new health scoring design | `steps/step-01-c-*` |
| **Edit** | Modify existing health scoring design | `steps/step-10-e-*` |
| **Validate** | Check health scoring design against quality criteria | `steps/step-20-v-*` |

Default: **Create** mode. In headless mode, always use Create.

### Create Mode
Follow the steps in `steps/` sequentially:
- `step-01-c-define-metrics.md` - Define health input metrics
- `step-02-c-design-weights.md` - Design metric weights and normalization
- `step-03-c-design-algorithm.md` - Design composite scoring algorithm
- `step-04-c-design-thresholds.md` - Design health thresholds and actions

### Edit Mode
Load the existing output artifact, then follow:
- `step-10-e-load-existing.md` - Load existing health scoring design
- `step-11-e-apply-changes.md` - Apply targeted modifications

### Validate Mode
Load the existing output artifact, then follow:
- `step-20-v-load-artifact.md` - Load health scoring design
