...
Generate validation report for performance baseline design.
...
| Gate | Contribution |
|------|--------------|
| QG-P1 (Production) | Performance baseline readiness |

### 3. Save Report

| Action | Path |
|--------|------|
| Output to | `{output_folder}/planning-artifacts/validation/performance-baseline-validation-report.md` |
...
- Validation report at `{output_folder}/planning-artifacts/validation/performance-baseline-validation-report.md`
