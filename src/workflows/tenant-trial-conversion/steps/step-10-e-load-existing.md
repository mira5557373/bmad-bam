...
Load and review existing trial conversion documents to identify sections requiring modification.

---

## Prerequisites

- Existing trial conversion documents to modify
...
|-----------|--------|-------------------|
| Trial Configuration | Yes/No | {duration, type, limits} |
| Conversion Triggers | Yes/No | {triggers defined} |
| Engagement Events | Yes/No | {events count} |
| Scoring Model | Yes/No | {thresholds defined} |
| Nurture Sequences | Yes/No | {sequences count} |
| Self-Service Flow | Yes/No | {steps defined} |
| Sales Handoff | Yes/No | {criteria defined} |
...
- **P (Party Mode)**: Bring growth perspectives on proposed changes
...
- Context: "Review proposed modifications to trial conversion design"
- Process growth and product perspectives on change impact
...
- Summary of current trial conversion state
