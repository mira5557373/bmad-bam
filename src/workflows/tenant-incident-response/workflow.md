...
|------|-------------|-------------|
| **Create** | Generate new incident response plan from scratch | `steps/` |
| **Edit** | Load existing incident response plan and apply targeted modifications | `steps/` |
| **Validate** | Check existing incident response plan against quality criteria | `steps/` |
...
- Tenant-aware observability design completed (recommended)
