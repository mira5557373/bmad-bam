...
Load and review existing incident response documents to identify sections requiring modification.

---

## Prerequisites

- Existing incident response documents to modify
...
|-----------|--------|-------------------|
| Severity levels | Yes/No | {levels defined} |
| Tenant impact matrix | Yes/No | {matrix complete} |
| Isolation protocol | Yes/No | {quarantine steps} |
| Communication plan | Yes/No | {channels defined} |
| Recovery procedures | Yes/No | {phases defined} |
| Playbooks | Yes/No | {playbook count} |
...
- Context: "Review proposed modifications to incident response plan"
- Process SRE and security perspectives on change impact
...
- Summary of current incident response state
