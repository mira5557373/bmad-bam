...
|------|-------------|-------------|
| **Create** | Generate new maintenance window design | `steps/step-01-c-*` |
| **Edit** | Modify existing maintenance window design | `steps/step-10-e-*` |
| **Validate** | Check maintenance window design against quality criteria | `steps/step-20-v-*` |

Default: **Create** mode. In headless mode, always use Create.

### Create Mode
Follow the steps in `steps/` sequentially:
- `step-01-c-window-planning.md` - Plan maintenance windows
- `step-02-c-tenant-coordination.md` - Design tenant coordination
- `step-03-c-assembly.md` - Combine into maintenance-window-design.md

### Edit Mode
Load the existing output artifact, then follow:
- `step-10-e-load-existing.md` - Load existing maintenance window design
- `step-11-e-apply-changes.md` - Apply targeted modifications

### Validate Mode
Load the existing output artifact, then follow:
- `step-20-v-load-artifact.md` - Load maintenance window design
