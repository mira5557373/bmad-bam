...
This completes the Validate mode. If validation passed, proceed to downstream workflows like `create-master-architecture`. If validation failed, enter Edit mode via `step-10-e-load-artifact.md` to address critical findings.

## Workflow Complete

Validation complete. Address any critical findings before proceeding to `create-master-architecture`.
