...
Load the AI guardrails architecture documents for validation against safety and compliance criteria.

---

## Prerequisites

- AI guardrails architecture artifact exists to validate
...
Parse the document structure and prepare for validation against safety criteria.

### 3. Pre-Validation Check

| Component | Present | Status |
|-----------|---------|--------|
| Input Filtering | Yes/No | {ready/incomplete} |
| Output Validation | Yes/No | {ready/incomplete} |
| Framework Selection | Yes/No | {ready/incomplete} |
| Policy Engine | Yes/No | {ready/incomplete} |
...
- **P (Party Mode)**: Bring QA and AI safety perspectives on validation approach
- **C (Continue)**: Proceed to detailed validation against safety criteria
...
- Context: "Review AI guardrails architecture artifact readiness for validation"
- Process QA and AI safety perspectives
...
Proceed to `step-21-v-validate.md` to run validation checks against safety criteria.
