...
Load existing cost optimization strategy for modification.
...
- Cost optimization strategy artifact exists at output location
...
| Action | Path |
|--------|------|
| Load | `{output_folder}/planning-artifacts/operations/cost-optimization-strategy.md` |
...
- Loaded cost optimization strategy content
