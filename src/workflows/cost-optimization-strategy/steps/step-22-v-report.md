...
Generate validation report for cost optimization strategy.
...
| Gate | Contribution |
|------|--------------|
| QG-P1 (Production) | Cost optimization readiness |

### 3. Save Report

| Action | Path |
|--------|------|
| Output to | `{output_folder}/planning-artifacts/validation/cost-optimization-validation-report.md` |
...
- Validation report at `{output_folder}/planning-artifacts/validation/cost-optimization-validation-report.md`
