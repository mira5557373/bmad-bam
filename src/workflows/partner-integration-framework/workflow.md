...
|------|-------------|-------------|
| **Create** | Generate new partner framework from scratch | `steps/` |
| **Edit** | Load existing framework and apply targeted modifications | `steps/` |
| **Validate** | Check existing framework against quality criteria | `steps/` |
