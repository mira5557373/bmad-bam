...
**Use when:**
- Designing the tenant provisioning process for a new platform
- No tenant onboarding runbook exists
- Adding new tier support (e.g., Enterprise tier with dedicated resources)
- Integrating with new billing or identity providers

**Do NOT use when:**
- Onboarding runbook already exists (use Edit mode)
- Designing tenant offboarding (use `tenant-offboarding-design` workflow)
- Only updating billing integration (use Edit mode with specific focus)
...
- Understanding of tier definitions and entitlements
- Billing system integration requirements (Stripe, AWS Marketplace, etc.)
