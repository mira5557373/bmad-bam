...
This step loads the existing tenant onboarding documents for modification. Edit mode allows updates to provisioning stages, data initialization, tier configurations, or runbook procedures without recreating the entire onboarding design from scratch.

---

## Prerequisites

- Existing onboarding documents to modify
...
- Context: "Review onboarding modification: {summary of current state and proposed changes}"
...
- Summary of current onboarding configuration
