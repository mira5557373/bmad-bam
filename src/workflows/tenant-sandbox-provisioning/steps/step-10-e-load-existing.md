...
Load and review existing tenant sandbox provisioning design documents to identify sections requiring modification.

---

## Prerequisites

- Existing sandbox provisioning documents to modify
...
Load the existing sandbox provisioning design:
...
|-----------|--------|-------------------|
| Sandbox Creation | YES/NO | {types defined} |
| Data Seeding | YES/NO | {seed categories} |
| Cleanup | YES/NO | {expiration policy} |
| Isolation | YES/NO | {requirements} |
...
- Context: "Review proposed modifications to sandbox provisioning design"
...
- Summary of current sandbox provisioning state
