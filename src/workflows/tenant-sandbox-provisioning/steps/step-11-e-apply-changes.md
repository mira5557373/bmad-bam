...
Apply targeted modifications to the sandbox provisioning design, documenting changes with ADR rationale.
...
- Context: "Review applied changes to sandbox provisioning design"
...
- Updated sandbox provisioning design
- ADR for changes
- Change log entry
