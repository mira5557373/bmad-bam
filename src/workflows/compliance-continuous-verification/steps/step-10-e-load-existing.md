...
Load and review existing compliance continuous verification design documents to identify sections requiring modification.
...
Load the existing compliance verification design:
- `{output_folder}/planning-artifacts/compliance/compliance-continuous-verification.md`
...
|-----------|--------|-------------------|
| Compliance Rules | YES/NO | {frameworks covered} |
| Scanning Engine | YES/NO | {scan frequency} |
| Evidence Collection | YES/NO | {collection methods} |
| Reporting | YES/NO | {report types} |
...
- Context: "Review proposed modifications to compliance verification design"
...
- Summary of current compliance verification state
