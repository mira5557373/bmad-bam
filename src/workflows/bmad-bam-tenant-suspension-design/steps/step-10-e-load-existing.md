...
This step loads the existing tenant suspension documents for modification. Edit mode allows updates to state machine, triggers, grace periods, or notification sequences without recreating the entire suspension design from scratch.

---

## Prerequisites

- Existing suspension documents to modify
...
- Context: "Review suspension modification: {summary of current state and proposed changes}"
...
- Summary of current suspension configuration
