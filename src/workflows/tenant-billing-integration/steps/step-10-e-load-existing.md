...
This step loads the existing billing integration documents for modification. Edit mode allows updates to billing requirements, pricing models, payment processing, subscription management, or reconciliation without recreating the entire billing design from scratch.

---

## Prerequisites

- Existing billing integration documents to modify
...
- Billing requirements and provider
...
- Context: "Review existing billing integration for modification: {summary of current state}"
...
- Summary of current billing configuration
