...
Load existing chaos engineering design for modification.
...
- Chaos engineering design artifact exists at output location
...
| Action | Path |
|--------|------|
| Load | `{output_folder}/planning-artifacts/operations/chaos-engineering-design.md` |
...
- Loaded chaos engineering design content
