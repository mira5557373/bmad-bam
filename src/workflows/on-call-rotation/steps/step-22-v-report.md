...
Generate validation report for on-call rotation design.
...
| Gate | Contribution |
|------|--------------|
| QG-P1 (Production) | On-call coverage readiness |

### 3. Save Report

| Action | Path |
|--------|------|
| Output to | `{output_folder}/planning-artifacts/validation/on-call-rotation-validation-report.md` |
...
- Validation report at `{output_folder}/planning-artifacts/validation/on-call-rotation-validation-report.md`
