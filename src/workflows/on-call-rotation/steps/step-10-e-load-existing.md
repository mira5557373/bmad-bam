...
Load existing on-call rotation design for modification.
...
- On-call rotation design artifact exists at output location
...
| Action | Path |
|--------|------|
| Load | `{output_folder}/planning-artifacts/operations/on-call-rotation-design.md` |
...
- Loaded on-call rotation design content
