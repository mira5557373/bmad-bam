...
|------|-------------|-------------|
| **Create** | Generate new on-call rotation design | `steps/step-01-c-*` |
| **Edit** | Modify existing on-call rotation design | `steps/step-10-e-*` |
| **Validate** | Check on-call rotation design against quality criteria | `steps/step-20-v-*` |

Default: **Create** mode. In headless mode, always use Create.

### Create Mode
Follow the steps in `steps/` sequentially:
- `step-01-c-rotation-design.md` - Design rotation schedules
- `step-02-c-escalation-policy.md` - Design escalation policies
- `step-03-c-assembly.md` - Combine into on-call-rotation-design.md

### Edit Mode
Load the existing output artifact, then follow:
- `step-10-e-load-existing.md` - Load existing on-call rotation design
- `step-11-e-apply-changes.md` - Apply targeted modifications

### Validate Mode
Load the existing output artifact, then follow:
- `step-20-v-load-artifact.md` - Load on-call rotation design
