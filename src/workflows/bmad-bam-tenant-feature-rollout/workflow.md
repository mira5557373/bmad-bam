...
|------|-------------|-------------|
| **Create** | Generate new feature rollout design | `steps/step-01-c-*` |
| **Edit** | Modify existing feature rollout design | `steps/step-10-e-*` |
| **Validate** | Check feature rollout design against quality criteria | `steps/step-20-v-*` |

Default: **Create** mode. In headless mode, always use Create.

### Create Mode
Follow the steps in `steps/` sequentially:
- `step-01-c-design-feature-flags.md` - Design tenant-specific feature flag system
- `step-02-c-design-rollout-strategy.md` - Define canary and progressive rollout strategy
- `step-03-c-design-monitoring.md` - Design monitoring and observability
- `step-04-c-design-rollback.md` - Design rollback procedures
- `step-05-c-assembly.md` - Combine into feature-rollout-design.md

### Edit Mode
Load the existing output artifact, then follow:
- `step-10-e-load-existing.md` - Load existing feature rollout design
- `step-11-e-apply-changes.md` - Apply targeted modifications

### Validate Mode
Load the existing output artifact, then follow:
- `step-20-v-load-artifact.md` - Load feature rollout design
