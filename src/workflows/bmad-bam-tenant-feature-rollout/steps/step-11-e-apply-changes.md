...
Apply targeted modifications to the feature rollout design, documenting changes with ADR rationale.
...
- Context: "Review applied changes to feature rollout design"
...
- Updated feature rollout design
- ADR for changes
- Change log entry
