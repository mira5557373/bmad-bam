...
Load and review existing AI bias monitoring documents to identify sections requiring modification.

## Prerequisites

- Existing AI bias monitoring documents to modify
...
- **P (Party Mode)**: Bring AI Ethics Researcher, Data Scientist, and Compliance Auditor perspectives
...
- [ ] Bias monitoring document loaded successfully
...
- Summary of current AI bias monitoring state
