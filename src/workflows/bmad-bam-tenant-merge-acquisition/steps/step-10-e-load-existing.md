...
Load and review existing M&A consolidation documents to identify sections requiring modification.

---

## Prerequisites

- Existing M&A consolidation documents to modify
...
Load the existing M&A consolidation documents:
...
|-----------|--------|-------------------|
| Merge Scenarios | Yes/No | {scenarios defined} |
| Data Consolidation | Yes/No | {requirements mapped} |
| Migration Pipeline | Yes/No | {phases defined} |
| User Merging | Yes/No | {strategy defined} |
| Billing Consolidation | Yes/No | {approach defined} |
| Permission Harmonization | Yes/No | {rules defined} |
| Runbook | Yes/No | {procedures count} |
| Rollback Strategy | Yes/No | {strategy defined} |
...
- **P (Party Mode)**: Bring data architecture perspectives on proposed changes
...
- Context: "Review proposed modifications to M&A consolidation design"
- Process data architecture and operations perspectives on change impact
...
- Summary of current M&A consolidation state
