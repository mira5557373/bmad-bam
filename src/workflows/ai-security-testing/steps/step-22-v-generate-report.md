...
Save to: `{output_folder}/planning-artifacts/validation/ai-security-testing-validation-report.md`
...
| Gate | Decision | Notes |
|------|----------|-------|
| AI Security Testing | {PASS/CONDITIONAL/FAIL} | {summary} |
...
- Context: "Review AI security testing validation report"
...
- Validation report: `{output_folder}/planning-artifacts/validation/ai-security-testing-validation-report.md`
