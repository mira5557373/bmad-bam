# Step 20: Validate Quarterly Setup

## Purpose

Validate the quarterly operations review configuration.

## Prerequisites

- Quarterly schedule exists

## Actions

### 1. Validate Configuration

Check that all required elements are configured:
- Review dates set
...
Search the web: "operational review gate criteria {date}"
