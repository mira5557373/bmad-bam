...
|------|-------------|-------------|
| **Create** | Generate new SDK pipeline from scratch | `steps/` |
| **Edit** | Load existing SDK configuration and apply targeted modifications | `steps/` |
| **Validate** | Check existing SDK against quality criteria | `steps/` |
