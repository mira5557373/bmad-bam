...
Apply targeted modifications to runbook automation design.
...
| Action | Path |
|--------|------|
| Save | `{output_folder}/planning-artifacts/operations/runbook-automation-design.md` |
...
- Updated runbook automation design
