...
This step loads the existing payment processing documents for modification. Edit mode allows updates to gateway configuration, payment methods, transaction processing, or webhook handling without recreating the entire design from scratch.

---

## Prerequisites

- Existing payment processing documents to modify
...
- Context: "Review existing payment processing design for modification: {summary of current state}"
...
- Summary of current payment processing configuration
