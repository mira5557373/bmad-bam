...
Apply targeted modifications to change management process.
...
| Action | Path |
|--------|------|
| Save | `{output_folder}/planning-artifacts/operations/change-management-process.md` |
...
- Updated change management process
