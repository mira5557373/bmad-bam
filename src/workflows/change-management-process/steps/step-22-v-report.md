...
Generate validation report for change management process.
...
| Gate | Contribution |
|------|--------------|
| QG-P1 (Production) | Change management readiness |

### 3. Save Report

| Action | Path |
|--------|------|
| Output to | `{output_folder}/planning-artifacts/validation/change-management-validation-report.md` |
...
- Validation report at `{output_folder}/planning-artifacts/validation/change-management-validation-report.md`
