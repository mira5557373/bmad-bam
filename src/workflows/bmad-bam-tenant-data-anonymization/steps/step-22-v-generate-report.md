...
Save to: `{output_folder}/planning-artifacts/validation/data-anonymization-validation-report.md`
...
| Gate | Decision | Notes |
|------|----------|-------|
| Data Anonymization | {PASS/CONDITIONAL/FAIL} | {summary} |
...
- Context: "Review data anonymization validation report"
...
- Validation report: `{output_folder}/planning-artifacts/validation/data-anonymization-validation-report.md`
