...
This step loads the existing tenant hierarchy design documents for modification. Edit mode allows updates to hierarchy structure, permission inheritance, billing rollup, or quota distribution without recreating the entire design from scratch.

---

## Prerequisites

- Existing hierarchy design documents to modify
...
Load the existing tenant hierarchy documents:
...
- Context: "Review hierarchy modification: {summary of current state and proposed changes}"
...
- Summary of current hierarchy configuration
