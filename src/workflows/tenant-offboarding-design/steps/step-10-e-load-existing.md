...
This step loads the existing tenant offboarding documents for modification. Edit mode allows updates to deprovisioning stages, data retention policies, cleanup procedures, or runbook steps without recreating the entire offboarding design from scratch.

---

## Prerequisites

- Existing offboarding documents to modify
...
- Context: "Review offboarding modification: {summary of current state and proposed changes}"
...
- Summary of current offboarding configuration
