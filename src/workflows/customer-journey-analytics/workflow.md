...
|------|-------------|-------------|
| **Create** | Generate new journey analytics design | `steps/step-01-c-*` |
| **Edit** | Modify existing journey analytics design | `steps/step-10-e-*` |
| **Validate** | Check journey analytics design against quality criteria | `steps/step-20-v-*` |

Default: **Create** mode. In headless mode, always use Create.

### Create Mode
Follow the steps in `steps/` sequentially:
- `step-01-c-map-journeys.md` - Map customer journeys and touchpoints
- `step-02-c-design-tracking.md` - Design journey event tracking
- `step-03-c-design-optimization.md` - Design journey optimization

### Edit Mode
Load the existing output artifact, then follow:
- `step-10-e-load-existing.md` - Load existing journey analytics design
- `step-11-e-apply-changes.md` - Apply targeted modifications

### Validate Mode
Load the existing output artifact, then follow:
- `step-20-v-load-artifact.md` - Load journey analytics design
