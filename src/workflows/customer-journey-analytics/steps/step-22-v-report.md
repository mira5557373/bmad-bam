...
Generate validation report for customer journey analytics design.
...
- QG-P1 (Production): Journey analytics readiness

### 3. Save Report

Output to: `{output_folder}/planning-artifacts/validation/customer-journey-analytics-validation-report.md`
...
- Validation report at `{output_folder}/planning-artifacts/validation/customer-journey-analytics-validation-report.md`
