...
Apply targeted modifications to on-call rotation design.
...
| Action | Path |
|--------|------|
| Save | `{output_folder}/planning-artifacts/operations/on-call-rotation-design.md` |
...
- Updated on-call rotation design
