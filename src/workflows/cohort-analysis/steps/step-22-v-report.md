...
Generate validation report for cohort analysis design.
...
- QG-P1 (Production): Analytics readiness

### 3. Save Report

Output to: `{output_folder}/planning-artifacts/validation/cohort-analysis-validation-report.md`
...
- Validation report at `{output_folder}/planning-artifacts/validation/cohort-analysis-validation-report.md`
