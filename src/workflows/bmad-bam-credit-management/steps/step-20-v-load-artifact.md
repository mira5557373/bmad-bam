...
Load the Credit Management artifacts for validation.
...
Load: `{output_folder}/planning-artifacts/billing/credit-management-design.md`

---

## Outputs

- Loaded credit management documents
...
Proceed to Step 21: Validate Credit Management Design.
