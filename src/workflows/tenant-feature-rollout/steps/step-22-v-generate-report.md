...
Save to: `{output_folder}/planning-artifacts/validation/feature-rollout-validation-report.md`
...
| Gate | Decision | Notes |
|------|----------|-------|
| Feature Rollout | {PASS/CONDITIONAL/FAIL} | {summary} |
...
- Context: "Review feature rollout validation report"
...
- Validation report: `{output_folder}/planning-artifacts/validation/feature-rollout-validation-report.md`
