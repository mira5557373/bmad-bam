...
Load and review existing tenant feature rollout design documents to identify sections requiring modification.

---

## Prerequisites

- Existing feature rollout documents to modify
...
Load the existing feature rollout design:
- `{output_folder}/planning-artifacts/operations/tenant-feature-rollout.md`
...
|-----------|--------|-------------------|
| Feature Flags | YES/NO | {flag types} |
| Rollout Strategy | YES/NO | {stages defined} |
| Monitoring | YES/NO | {metrics} |
| Rollback | YES/NO | {triggers} |
...
- Context: "Review proposed modifications to feature rollout design"
...
- Summary of current feature rollout state
