...
|------|-------------|-------------|
| **Create** | Generate new contract renewal design from scratch | `steps/` |
| **Edit** | Load existing renewal design and apply targeted modifications | `steps/` |
| **Validate** | Check existing renewal design against quality criteria | `steps/` |
