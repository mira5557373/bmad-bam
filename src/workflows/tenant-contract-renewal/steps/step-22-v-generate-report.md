...
Generate a comprehensive validation report summarizing findings from the contract renewal validation steps and determining the workflow completion status.

---

## Prerequisites

- Step 20 completed: Contract renewal artifact loaded successfully
...
|----------|--------|-------|
| Contract Types | | Types, terms, policies |
| Renewal Scenarios | | Scenarios, actions |
| Pricing Rules | | Changes, grandfathering |
| Notifications | | Pre/post, compliance |
| Renegotiation | | Workflow, SLAs |
...
|----------|-------------|-----------------|
| CRITICAL | Blocks compliant renewal | Must fix before launch |
| WARNING | Non-critical gap | Should address before scale |
| INFO | Improvement opportunity | Consider for future iterations |

**Critical Failure Examples:**
- Non-compliant notification timeline
- Missing renewal scenarios
- Undefined pricing rules
- No monitoring or escalation

### 3. Determine Completion Status

| Status | Criteria |
|--------|----------|
| **COMPLETE** | All components defined, critical checks pass, compliance verified |
...
- **P (Party Mode)**: Bring PM and finance perspectives on next steps
...
- Context: "Review contract renewal validation report and recommend next steps"
- Process PM and finance perspectives
...
- Contract Renewal Validation Report
- Component-level findings summary
- Gate decision documentation
- **Output to:** `{output_folder}/planning-artifacts/operations/contract-renewal-validation-report.md`
...
- **COMPLETE:** Workflow finished. Contract renewal design is ready for implementation.
...
Validation mode complete for tenant-contract-renewal workflow.
