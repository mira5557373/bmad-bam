...
Assemble all components into final runbook automation design document.
...
- All runbook automation components documented
...
| Runbook Structure | Step 1 output | High |
| Automation Patterns | Step 2 output | High |
| Tooling | Recommended tools | Medium |
...
| Automation rate | Automated / Total runbooks | > 70% |
| Success rate | Successful / Total executions | > 95% |
| Toil reduction | Hours saved / Total hours | > 50% |

### 3. Save Document

Output to: `{output_folder}/planning-artifacts/operations/runbook-automation-design.md`
...
- Runbook automation design at `{output_folder}/planning-artifacts/operations/runbook-automation-design.md`
