...
Generate validation report for runbook automation design.
...
| Gate | Contribution |
|------|--------------|
| QG-P1 (Production) | Operational automation readiness |

### 3. Save Report

| Action | Path |
|--------|------|
| Output to | `{output_folder}/planning-artifacts/validation/runbook-automation-validation-report.md` |
...
- Validation report at `{output_folder}/planning-artifacts/validation/runbook-automation-validation-report.md`
