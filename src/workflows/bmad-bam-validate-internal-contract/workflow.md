...
Default: **Validate** mode for this workflow. In headless mode, always use Validate.
...
- **Entry Gate:** Internal contract must exist

## Quality Gate

**Gate:** QG-M2-INTERNAL (Internal Contract Validation)
