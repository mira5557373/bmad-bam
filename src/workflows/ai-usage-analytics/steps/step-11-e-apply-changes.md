...
Apply targeted modifications to AI usage analytics design.
...
Save to: `{output_folder}/planning-artifacts/analytics/ai-usage-analytics-design.md`
...
- Updated AI analytics design document
