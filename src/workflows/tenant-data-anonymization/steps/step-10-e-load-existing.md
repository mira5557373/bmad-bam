...
Load and review existing tenant data anonymization design documents to identify sections requiring modification.

---

## Prerequisites

- Existing data anonymization documents to modify
...
Load the existing data anonymization design:
...
|-----------|--------|-------------------|
| Data Classification | YES/NO | {levels defined} |
| Anonymization Rules | YES/NO | {techniques} |
| Verification Checks | YES/NO | {automated tests} |
| Compliance Evidence | YES/NO | {documentation} |
...
- Context: "Review proposed modifications to data anonymization design"
...
- Summary of current data anonymization state
