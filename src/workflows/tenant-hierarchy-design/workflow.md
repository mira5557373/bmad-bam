...
|------|-------------|-------------|
| **Create** | Generate new tenant hierarchy design | `steps/step-01-c-*` |
| **Edit** | Modify existing tenant hierarchy design | `steps/step-10-e-*` |
| **Validate** | Check tenant hierarchy design against quality criteria | `steps/step-20-v-*` |

Default: **Create** mode. In headless mode, always use Create.

### Create Mode
Follow the steps in `steps/` sequentially:
- `step-01-c-hierarchy-definition.md` - Define organizational hierarchy structure
- `step-02-c-permission-inheritance.md` - Design permission inheritance model
- `step-03-c-billing-rollup.md` - Design cost aggregation across hierarchy
- `step-04-c-quota-inheritance.md` - Define resource quota distribution
- `step-05-c-assembly.md` - Combine into tenant-hierarchy-design.md

### Edit Mode
Load the existing output artifact, then follow:
- `step-10-e-load-existing.md` - Load existing hierarchy design
- `step-11-e-apply-changes.md` - Apply targeted modifications

### Validate Mode
Load the existing output artifact, then follow:
- `step-20-v-load-artifact.md` - Load tenant hierarchy design
