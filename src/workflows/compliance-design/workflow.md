...
**Goal:** Design the compliance framework including regulatory requirements mapping, audit controls, data residency, and certification preparation.
...
|------|-------------|-------------|
| **Create** | Design new compliance framework | `steps/step-01-c-*` |
| **Edit** | Update compliance requirements | `steps/step-10-e-*` |
| **Validate** | Check against compliance checklist | `steps/step-20-v-*` |
...
### Edit Mode
Load the existing compliance-design.md, then follow `step-1X-e-` (10 through 11).

### Validate Mode
Load the existing compliance-design.md, then follow `step-2X-v-` (20 through 21).
...
2. **Load BAM config** and resolve:
   - Use `{tenant_model}` for tenant isolation decisions (critical for compliance)
...
4. **Web Research Required**
   This workflow requires web search for current compliance requirements.
   Search queries from `compliance-frameworks.csv` based on target regulations.

5. **EXECUTION**
   Read fully and follow: `./steps/step-01-c-identify-frameworks.md` to begin.
