...
Generate a comprehensive validation report for refund processing design.
...
Generate report to: `{output_folder}/planning-artifacts/billing/refund-processing-validation-report.md`
...
- `{output_folder}/planning-artifacts/billing/refund-processing-validation-report.md`
