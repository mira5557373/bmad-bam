...
|------|-------------|-------------|
| **Create** | Generate new performance baseline design | `steps/step-01-c-*` |
| **Edit** | Modify existing performance baseline design | `steps/step-10-e-*` |
| **Validate** | Check performance baseline design against quality criteria | `steps/step-20-v-*` |

Default: **Create** mode. In headless mode, always use Create.

### Create Mode
Follow the steps in `steps/` sequentially:
- `step-01-c-metric-selection.md` - Select performance metrics
- `step-02-c-baseline-collection.md` - Design baseline collection
- `step-03-c-assembly.md` - Combine into performance-baseline-design.md

### Edit Mode
Load the existing output artifact, then follow:
- `step-10-e-load-existing.md` - Load existing performance baseline design
- `step-11-e-apply-changes.md` - Apply targeted modifications

### Validate Mode
Load the existing output artifact, then follow:
- `step-20-v-load-artifact.md` - Load performance baseline design
