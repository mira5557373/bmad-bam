...
Load and review existing tenant reactivation documents to identify sections requiring modification.

---

## Prerequisites

- Existing reactivation documents to modify
...
|-----------|--------|-------------------|
| Suspension States | Yes/No | {states defined} |
| Data Retention | Yes/No | {policies mapped} |
| Self-Service Flow | Yes/No | {steps defined} |
| Assisted Restoration | Yes/No | {process defined} |
| Win-Back Campaigns | Yes/No | {campaigns defined} |
| Data Restoration | Yes/No | {pipeline defined} |
...
- **P (Party Mode)**: Bring customer success perspectives on proposed changes
...
- Context: "Review proposed modifications to reactivation design"
- Process customer success and operations perspectives on change impact
...
- Summary of current reactivation state
