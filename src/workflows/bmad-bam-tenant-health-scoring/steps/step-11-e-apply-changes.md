...
Apply targeted modifications to health scoring design.
...
Save to: `{output_folder}/planning-artifacts/analytics/tenant-health-scoring-design.md`
...
- Updated health scoring design document
