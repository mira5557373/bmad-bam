...
| -------- | ----------------------------- | -------------------------------------- |
| QG-M1    | Master Architecture Readiness | After `bmad-bam-create-master-architecture` |
| QG-M2    | Tenant Isolation Complete     | After `bmad-bam-tenant-model-isolation`     |
| QG-M3    | Agent Runtime Readiness       | After `bmad-bam-agent-runtime-architecture` |
