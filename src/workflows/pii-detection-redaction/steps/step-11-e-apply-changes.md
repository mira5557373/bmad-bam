...
Apply requested modifications to PII detection architecture documents while maintaining consistency and integrity.
...
Based on the user's requested changes, identify all affected components in the PII detection architecture documents.
...
- Document structure
- Unaffected components (taxonomy, detection, redaction, policies)
- Cross-references between documents

### 4. Validate Privacy Consistency

If modifying privacy rules, verify:
- PII taxonomy consistency
- Detection coverage maintained
- Redaction methods compatible
...
- **P (Party Mode)**: Bring privacy and compliance perspectives on changes
...
- Context: "Review modifications to PII detection architecture for privacy and compliance"
...
- Updated PII detection architecture documents
