...
|------|-------------|-------------|
| **Create** | Generate new trial conversion design from scratch | `steps/` |
| **Edit** | Load existing conversion design and apply targeted modifications | `steps/` |
| **Validate** | Check existing conversion design against quality criteria | `steps/` |
