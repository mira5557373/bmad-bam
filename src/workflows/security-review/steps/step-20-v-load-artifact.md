...
Load the security assessment documents for validation against quality criteria for assessment completeness, finding accuracy, and remediation planning.

---

## Prerequisites

- Security assessment artifact exists to validate
...
|-----------|---------|--------|
| Scope assessment | Yes/No | {ready/incomplete} |
| Trust boundaries | Yes/No | {ready/incomplete} |
| Threat model | Yes/No | {ready/incomplete} |
| Tenant isolation review | Yes/No | {ready/incomplete} |
| AI safety review | Yes/No | {ready/incomplete} |
| Findings list | Yes/No | {ready/incomplete} |
| Remediation roadmap | Yes/No | {ready/incomplete} |
| Executive summary | Yes/No | {ready/incomplete} |
...
- Context: "Review security assessment artifact readiness for validation"
