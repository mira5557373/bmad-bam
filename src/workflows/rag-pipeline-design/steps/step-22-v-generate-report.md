...
Generate the final validation report for the RAG pipeline architecture, documenting findings, gate decision, and required remediation.
...
|----------|--------|-------|
| Ingestion | PASS/FAIL | {notes} |
| Chunking | PASS/FAIL | {notes} |
| Embedding | PASS/FAIL | {notes} |
| Retrieval | PASS/FAIL | {notes} |
| Hybrid Search | PASS/FAIL | {notes} |
...
- Validation report: `{output_folder}/planning-artifacts/validation/rag-pipeline-validation-report.md`
