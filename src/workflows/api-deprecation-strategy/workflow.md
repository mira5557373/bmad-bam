...
|------|-------------|-------------|
| **Create** | Generate new deprecation strategy from scratch | `steps/` |
| **Edit** | Load existing strategy and apply targeted modifications | `steps/` |
| **Validate** | Check existing strategy against quality criteria | `steps/` |
