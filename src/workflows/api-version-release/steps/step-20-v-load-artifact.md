...
This step loads the API Version Release artifact for validation. The release plan documents API changes, compatibility assessment, migration guides, and changelog to ensure smooth version transitions for all API consumers.
...
- Context: "Review loaded API release artifact for validation: {summary of document structure}"
