...
Load existing maintenance window design for modification.
...
- Maintenance window design artifact exists at output location
...
| Action | Path |
|--------|------|
| Load | `{output_folder}/planning-artifacts/operations/maintenance-window-design.md` |
...
- Loaded maintenance window design content
