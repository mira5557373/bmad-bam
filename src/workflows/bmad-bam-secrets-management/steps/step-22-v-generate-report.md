...
Generate a comprehensive validation report summarizing findings, recommendations, and compliance status for the secrets management plan.
...
- `{output_folder}/planning-artifacts/secrets-management-validation-report.md`

## Next Step

Validation workflow complete. Output validation report.
