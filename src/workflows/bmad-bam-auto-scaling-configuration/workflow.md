...
**Do NOT use when:**
- Auto-scaling configuration already exists (use Edit mode)
- Only updating scaling thresholds (use Edit mode with specific focus)
...
- Cost optimization requirements documented
