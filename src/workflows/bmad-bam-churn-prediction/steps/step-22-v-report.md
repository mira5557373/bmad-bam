...
Generate validation report for churn prediction design.
...
- QG-P1 (Production): Churn prediction readiness

### 3. Save Report

Output to: `{output_folder}/planning-artifacts/validation/churn-prediction-validation-report.md`
...
- Validation report at `{output_folder}/planning-artifacts/validation/churn-prediction-validation-report.md`
