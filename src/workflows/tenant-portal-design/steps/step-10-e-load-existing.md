...
This step loads the existing tenant portal design documents for modification. Edit mode allows updates to self-service capabilities, admin features, tier options, or billing integration without recreating the entire portal design from scratch.

---

## Prerequisites

- Existing portal design documents to modify
...
- Context: "Review portal modification: {summary of current state and proposed changes}"
...
- Summary of current portal configuration
