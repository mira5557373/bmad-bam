...
Load and review existing agent memory optimization documents to identify sections requiring modification.

---

## Prerequisites

- Existing memory optimization documents to modify
...
|-----------|--------|-------------------|
| Memory Audit | Present/Missing | {baseline metrics} |
| Tier Allocation | Present/Missing | {storage design} |
| Eviction Policies | Present/Missing | {algorithms, TTLs} |
| Tenant Quotas | Present/Missing | {limits, handling} |
| Performance Tuning | Present/Missing | {hot paths, optimization} |
| Cost Controls | Present/Missing | {tiering, cleanup} |
| Monitoring | Present/Missing | {metrics, alerts} |
| Testing | Present/Missing | {test plan} |
...
- Context: "Review proposed modifications to memory optimization"
...
- Summary of current memory optimization state
