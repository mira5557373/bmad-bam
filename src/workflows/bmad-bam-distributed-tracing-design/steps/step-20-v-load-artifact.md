...
This step loads the Distributed Tracing Design artifact for validation. This document defines the tracing infrastructure including OpenTelemetry configuration, context propagation, tenant correlation, and sampling strategies.
...
- Read the artifact from `{output_folder}/planning-artifacts/architecture/distributed-tracing-design.md`
...
- Cross-references to tenant model are valid

---

## Expected Artifact Structure

The distributed-tracing-design.md should contain:
- OpenTelemetry SDK configuration
- Trace exporter selection and configuration
- Context propagation patterns for all boundaries
- Tenant correlation attributes and middleware
- Tier-based sampling strategies
- Cost projections
...
- Context: "Review distributed tracing structure: {summary of sections and completeness}"
