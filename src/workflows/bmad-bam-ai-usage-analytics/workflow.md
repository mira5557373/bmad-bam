...
|------|-------------|-------------|
| **Create** | Generate new AI analytics design | `steps/step-01-c-*` |
| **Edit** | Modify existing AI analytics design | `steps/step-10-e-*` |
| **Validate** | Check AI analytics design against quality criteria | `steps/step-20-v-*` |

Default: **Create** mode. In headless mode, always use Create.

### Create Mode
Follow the steps in `steps/` sequentially:
- `step-01-c-define-metrics.md` - Define AI usage metrics
- `step-02-c-design-tracking.md` - Design token and latency tracking
- `step-03-c-design-cost-attribution.md` - Design cost attribution model
- `step-04-c-design-dashboards.md` - Design AI analytics dashboards

### Edit Mode
Load the existing output artifact, then follow:
- `step-10-e-load-existing.md` - Load existing AI analytics design
- `step-11-e-apply-changes.md` - Apply targeted modifications

### Validate Mode
Load the existing output artifact, then follow:
- `step-20-v-load-artifact.md` - Load AI analytics design
