...
|------|-------------|-------------|
| **Create** | Generate new tier migration plan from scratch | `steps/` |
| **Edit** | Load existing migration plan and apply targeted modifications | `steps/` |
| **Validate** | Check existing migration plan against quality criteria | `steps/` |
...
- Master architecture document with tier definitions (FREE/PRO/ENTERPRISE)
