...
|------|-------------|-------------|
| **Create** | Generate new M&A consolidation design from scratch | `steps/` |
| **Edit** | Load existing consolidation design and apply targeted modifications | `steps/` |
| **Validate** | Check existing consolidation design against quality criteria | `steps/` |
