...
|------|-------------|-------------|
| **Create** | Generate new instrumentation design | `steps/step-01-c-*` |
| **Edit** | Modify existing instrumentation design | `steps/step-10-e-*` |
| **Validate** | Check instrumentation design against quality criteria | `steps/step-20-v-*` |

Default: **Create** mode. In headless mode, always use Create.

### Create Mode
Follow the steps in `steps/` sequentially:
- `step-01-c-design-schema.md` - Design event schema and taxonomy
- `step-02-c-create-tracking-plan.md` - Create tracking plan
- `step-03-c-design-pipeline.md` - Design analytics pipeline
- `step-04-c-establish-governance.md` - Establish data governance

### Edit Mode
Load the existing output artifact, then follow:
- `step-10-e-load-existing.md` - Load existing instrumentation design
- `step-11-e-apply-changes.md` - Apply targeted modifications

### Validate Mode
Load the existing output artifact, then follow:
- `step-20-v-load-artifact.md` - Load instrumentation design
