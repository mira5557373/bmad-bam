...
Generate validation report for product analytics instrumentation design.
...
- QG-M2 (Tenant Isolation): Event isolation readiness
- QG-P1 (Production): Analytics infrastructure readiness

### 3. Save Report

Output to: `{output_folder}/planning-artifacts/validation/product-analytics-instrumentation-validation-report.md`
...
- Validation report at `{output_folder}/planning-artifacts/validation/product-analytics-instrumentation-validation-report.md`
