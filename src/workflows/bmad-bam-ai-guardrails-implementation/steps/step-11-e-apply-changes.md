...
Apply requested modifications to AI guardrails architecture documents while maintaining consistency and integrity.
...
Based on the user's requested changes, identify all affected components in the AI guardrails architecture documents.
...
- Document structure
- Unaffected components (input filtering, output validation, frameworks, policies)
- Cross-references between documents

### 4. Validate Policy Consistency

If modifying policies, verify:
- Override hierarchy still valid
...
- **P (Party Mode)**: Bring AI safety and security perspectives on changes
...
- Context: "Review modifications to AI guardrails architecture for safety and consistency"
- Process AI safety and security perspectives
...
- Updated AI guardrails architecture documents
