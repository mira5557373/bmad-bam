...
Generate validation report for health monitoring design.
...
- QG-P1 (Production): Health monitoring readiness

### 3. Save Report

Output to: `{output_folder}/planning-artifacts/validation/health-monitoring-validation-report.md`
...
- Validation report at `{output_folder}/planning-artifacts/validation/health-monitoring-validation-report.md`
