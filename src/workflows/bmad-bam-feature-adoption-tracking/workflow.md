...
|------|-------------|-------------|
| **Create** | Generate new adoption tracking design | `steps/step-01-c-*` |
| **Edit** | Modify existing adoption tracking design | `steps/step-10-e-*` |
| **Validate** | Check adoption tracking design against quality criteria | `steps/step-20-v-*` |

Default: **Create** mode. In headless mode, always use Create.

### Create Mode
Follow the steps in `steps/` sequentially:
- `step-01-c-define-catalog.md` - Define feature catalog and taxonomy
- `step-02-c-design-metrics.md` - Design adoption metrics and funnels
- `step-03-c-design-insights.md` - Design insights and recommendations

### Edit Mode
Load the existing output artifact, then follow:
- `step-10-e-load-existing.md` - Load existing adoption tracking design
- `step-11-e-apply-changes.md` - Apply targeted modifications

### Validate Mode
Load the existing output artifact, then follow:
- `step-20-v-load-artifact.md` - Load adoption tracking design
