...
- `{project-root}/_bmad/bam/templates/contract-test-plan-template.md` - Module contract verification testing
- `{project-root}/_bmad/bam/templates/convergence-report-template.md` - Convergence verification report
