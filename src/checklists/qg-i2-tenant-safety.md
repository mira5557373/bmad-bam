...
- `{project-root}/_bmad/bam/templates/performance-test-plan-template.md` - Tenant performance isolation testing
- `{project-root}/_bmad/bam/templates/isolation-test-plan-template.md` - Tenant isolation test planning
