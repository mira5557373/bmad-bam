...
- `{project-root}/_bmad/bam/templates/agent-safety-report-template.md` - Agent safety verification report
- `{project-root}/_bmad/bam/templates/ai-eval-safety-template.md` - AI evaluation safety framework
