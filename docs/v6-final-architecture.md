...
Common parent of all listed skills = module dir = module.yaml location → PluginResolver Strategy 1 (`external/bmad-method/tools/installer/modules/plugin-resolver.js:72-99`) succeeds → real `module.yaml` is honored at install time.
