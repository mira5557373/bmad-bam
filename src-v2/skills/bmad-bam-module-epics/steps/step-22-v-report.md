...
```
================================================================================
EPIC VALIDATION REPORT GENERATED
================================================================================

DECISION: {PASS / CONDITIONAL / FAIL}
REPORT: {output_folder}/planning-artifacts/validation/epics-validation-report.md

================================================================================
Your options:
- **A (Advanced Elicitation)**: Deep dive into report findings
- **P (Party Mode)**: Stakeholder review of next steps
...
|-------|---------------------|
| **Report Contents** | Are all findings documented? |
| **Recommendations** | Are next steps clear? |
| **Recovery Plan** | Is remediation path defined? |
...
```
Review epic validation report and recommended next steps:
- Module: {module_name}
- Decision: {PASS/CONDITIONAL/FAIL}
- Issues: {issue_count}
```
...
|---------|------------|---------------|
| **Product Owner** | Approval | Can we proceed to implementation? |
| **Tech Lead** | Quality | Are issues acceptable? |
| **Scrum Master** | Process | What's the impact on planning? |
| **Stakeholder** | Sign-off | Do we approve conditions? |
