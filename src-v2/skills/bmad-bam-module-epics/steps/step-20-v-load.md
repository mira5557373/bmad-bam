...
After loading document, present options:

```
================================================================================
Your options:
- **A (Advanced Elicitation)**: Deep dive into document structure before validation
- **P (Party Mode)**: Product Owner and Tech Lead review of validation approach
...
| **Story Quality** | Is tenant context properly defined? |
| **Estimation Accuracy** | Are estimates realistic? |
| **Sprint Feasibility** | Is allocation achievable? |

Pass context: Document contents, epic list, story summary, specific concerns.
...
```
Review epic document before validation for module {module_name}:
- Epics: {epic_count}
- Stories: {story_count}
- Points: {total_points}
```
...
|---------|------------|---------------|
| **Product Owner** | Scope | Is all scope captured correctly? |
| **Tech Lead** | Feasibility | Is the plan technically achievable? |
| **QA Lead** | Testability | Are acceptance criteria testable? |
| **Scrum Master** | Process | Is sprint allocation realistic? |
