...
description: 'Design RAG (Retrieval-Augmented Generation) pipeline architecture for multi-tenant AI platforms covering vector storage isolation, semantic chunking, embedding lifecycle, hybrid search, and citation/grounding verification. Use when designing RAG pipelines, configuring multi-tenant vector stores, planning embedding strategies, or building retrieval-aware AI features.'
module: bam
