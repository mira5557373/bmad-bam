...
1. **step-01-c-context** - Initialize and gather requirements
2. **step-02-c-model** - Analyze options and patterns
3. **step-03-c-boundaries** - Design core solution
4. **step-04-c-patterns** - Document decisions
5. **step-05-c-document** - Compile final artifact
